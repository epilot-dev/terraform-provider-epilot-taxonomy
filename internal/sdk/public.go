...
func (s *Public) GetESPublicJwks(ctx context.Context, opts ...operations.Option) (*operations.GetESPublicJwksResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/entity/public/idp/.well-known/jwks.json")
	if err != nil {
	...
	res := &operations.GetESPublicJwksResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetESPublicJwksResponseBody
...
func (s *Public) GetESTokenOIDC(ctx context.Context, opts ...operations.Option) (*operations.GetESTokenOIDCResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/v1/entity/public/idp/.well-known/openid-configuration")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetESTokenOIDCResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetESTokenOIDCResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
