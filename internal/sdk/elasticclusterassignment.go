...
type ElasticClusterAssignment struct {
	rootSDK          *SDK
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newElasticClusterAssignment(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ElasticClusterAssignment {
	return &ElasticClusterAssignment{
		rootSDK:          rootSDK,
...
func (s *ElasticClusterAssignment) GetElasticClusterForOrg(ctx context.Context, request operations.GetElasticClusterForOrgRequest, opts ...operations.Option) (*operations.GetElasticClusterForOrgResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/internal/clusterAssignment/{orgId}", request, nil)
	if err != nil {
	...
	res := &operations.GetElasticClusterForOrgResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.ESClusterAssignment
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ESClusterAssignment = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
