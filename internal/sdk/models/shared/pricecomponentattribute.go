...
// PriceComponentAttributeDataClassification - Data classification of the attribute, used by anonymized responses (`?anonymize=true` or tokens minted with `anonymize: true`).
//
...
type PriceComponentAttributeDataClassification string

const (
	PriceComponentAttributeDataClassificationPublic PriceComponentAttributeDataClassification = "public"
	PriceComponentAttributeDataClassificationPii    PriceComponentAttributeDataClassification = "pii"
)

func (e PriceComponentAttributeDataClassification) ToPointer() *PriceComponentAttributeDataClassification {
	return &e
}
func (e *PriceComponentAttributeDataClassification) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "public":
		fallthrough
	case "pii":
		*e = PriceComponentAttributeDataClassification(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PriceComponentAttributeDataClassification: %v", v)
	}
}
...
type PriceComponentAttribute struct {
	...
	// When unset, built-in defaults apply based on the attribute type (email, phone, address, payment) and a curated list of well-known PII fields.
	//
	DataClassification *PriceComponentAttributeDataClassification `json:"data_classification,omitempty"`
...
func (p *PriceComponentAttribute) GetDataClassification() *PriceComponentAttributeDataClassification {
	if p == nil {
		return nil
	}
