...
// InternalAttributeDataClassification - Data classification of the attribute, used by anonymized responses (`?anonymize=true` or tokens minted with `anonymize: true`).
//
...
type InternalAttributeDataClassification string

const (
	InternalAttributeDataClassificationPublic InternalAttributeDataClassification = "public"
	InternalAttributeDataClassificationPii    InternalAttributeDataClassification = "pii"
)

func (e InternalAttributeDataClassification) ToPointer() *InternalAttributeDataClassification {
	return &e
}
func (e *InternalAttributeDataClassification) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "public":
		fallthrough
	case "pii":
		*e = InternalAttributeDataClassification(v)
		return nil
	default:
		return fmt.Errorf("invalid value for InternalAttributeDataClassification: %v", v)
	}
}
...
type InternalAttribute struct {
	...
	// When unset, built-in defaults apply based on the attribute type (email, phone, address, payment) and a curated list of well-known PII fields.
	//
	DataClassification *InternalAttributeDataClassification `json:"data_classification,omitempty"`
...
func (i *InternalAttribute) GetDataClassification() *InternalAttributeDataClassification {
	if i == nil {
		return nil
	}
