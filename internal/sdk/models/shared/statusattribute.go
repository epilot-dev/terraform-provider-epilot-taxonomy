...
// StatusAttributeDataClassification - Data classification of the attribute, used by anonymized responses (`?anonymize=true` or tokens minted with `anonymize: true`).
//
...
type StatusAttributeDataClassification string

const (
	StatusAttributeDataClassificationPublic StatusAttributeDataClassification = "public"
	StatusAttributeDataClassificationPii    StatusAttributeDataClassification = "pii"
)

func (e StatusAttributeDataClassification) ToPointer() *StatusAttributeDataClassification {
	return &e
}
func (e *StatusAttributeDataClassification) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "public":
		fallthrough
	case "pii":
		*e = StatusAttributeDataClassification(v)
		return nil
	default:
		return fmt.Errorf("invalid value for StatusAttributeDataClassification: %v", v)
	}
}
...
type StatusAttribute struct {
	...
	// When unset, built-in defaults apply based on the attribute type (email, phone, address, payment) and a curated list of well-known PII fields.
	//
	DataClassification *StatusAttributeDataClassification `json:"data_classification,omitempty"`
...
func (s *StatusAttribute) GetDataClassification() *StatusAttributeDataClassification {
	if s == nil {
		return nil
	}
