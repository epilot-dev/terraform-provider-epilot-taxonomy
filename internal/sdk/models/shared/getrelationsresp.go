...
type GetRelationsResp struct {
	RelationItem   *RelationItem   `queryParam:"inline,name=GetRelationsResp" union:"member"`
	RelationEntity *RelationEntity `queryParam:"inline,name=GetRelationsResp" union:"member"`
