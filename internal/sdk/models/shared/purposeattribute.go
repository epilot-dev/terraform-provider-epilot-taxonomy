...
// PurposeAttributeDataClassification - Data classification of the attribute, used by anonymized responses (`?anonymize=true` or tokens minted with `anonymize: true`).
//
...
type PurposeAttributeDataClassification string

const (
	PurposeAttributeDataClassificationPublic PurposeAttributeDataClassification = "public"
	PurposeAttributeDataClassificationPii    PurposeAttributeDataClassification = "pii"
)

func (e PurposeAttributeDataClassification) ToPointer() *PurposeAttributeDataClassification {
	return &e
}
func (e *PurposeAttributeDataClassification) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "public":
		fallthrough
	case "pii":
		*e = PurposeAttributeDataClassification(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PurposeAttributeDataClassification: %v", v)
	}
}
...
type PurposeAttribute struct {
	...
	// When unset, built-in defaults apply based on the attribute type (email, phone, address, payment) and a curated list of well-known PII fields.
	//
	DataClassification *PurposeAttributeDataClassification `json:"data_classification,omitempty"`
...
func (p *PurposeAttribute) GetDataClassification() *PurposeAttributeDataClassification {
	if p == nil {
		return nil
	}
