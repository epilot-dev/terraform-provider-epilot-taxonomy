...
// AddressRelationAttributeDataClassification - Data classification of the attribute, used by anonymized responses (`?anonymize=true` or tokens minted with `anonymize: true`).
//
...
type AddressRelationAttributeDataClassification string

const (
	AddressRelationAttributeDataClassificationPublic AddressRelationAttributeDataClassification = "public"
	AddressRelationAttributeDataClassificationPii    AddressRelationAttributeDataClassification = "pii"
)

func (e AddressRelationAttributeDataClassification) ToPointer() *AddressRelationAttributeDataClassification {
	return &e
}
func (e *AddressRelationAttributeDataClassification) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "public":
		fallthrough
	case "pii":
		*e = AddressRelationAttributeDataClassification(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AddressRelationAttributeDataClassification: %v", v)
	}
}
...
type AddressRelationAttribute struct {
	...
	// When unset, built-in defaults apply based on the attribute type (email, phone, address, payment) and a curated list of well-known PII fields.
	//
	DataClassification *AddressRelationAttributeDataClassification `json:"data_classification,omitempty"`
...
func (a *AddressRelationAttribute) GetDataClassification() *AddressRelationAttributeDataClassification {
	if a == nil {
		return nil
	}
