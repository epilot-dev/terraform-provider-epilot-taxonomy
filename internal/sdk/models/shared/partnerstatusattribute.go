...
// PartnerStatusAttributeDataClassification - Data classification of the attribute, used by anonymized responses (`?anonymize=true` or tokens minted with `anonymize: true`).
//
...
type PartnerStatusAttributeDataClassification string

const (
	PartnerStatusAttributeDataClassificationPublic PartnerStatusAttributeDataClassification = "public"
	PartnerStatusAttributeDataClassificationPii    PartnerStatusAttributeDataClassification = "pii"
)

func (e PartnerStatusAttributeDataClassification) ToPointer() *PartnerStatusAttributeDataClassification {
	return &e
}
func (e *PartnerStatusAttributeDataClassification) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "public":
		fallthrough
	case "pii":
		*e = PartnerStatusAttributeDataClassification(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PartnerStatusAttributeDataClassification: %v", v)
	}
}
...
type PartnerStatusAttribute struct {
	...
	// When unset, built-in defaults apply based on the attribute type (email, phone, address, payment) and a curated list of well-known PII fields.
	//
	DataClassification *PartnerStatusAttributeDataClassification `json:"data_classification,omitempty"`
...
func (p *PartnerStatusAttribute) GetDataClassification() *PartnerStatusAttributeDataClassification {
	if p == nil {
		return nil
	}
