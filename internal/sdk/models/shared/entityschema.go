...
// GridLayout - Widget-grid layout for the entity-details page (builder-authored); columns/cells drive the grid geometry.
...
func (g *GridLayout) GetCells() []float64 {
	if g == nil {
		return nil
	}
	return g.Cells
...
func (g *GridLayout) GetColumns() *float64 {
	if g == nil {
		return nil
	}
	return g.Columns
...
type EntitySchemaUIConfig struct {
	...
	GridLayout *GridLayout `json:"grid_layout,omitempty"`
...
func (e *EntitySchemaUIConfig) GetGridLayout() *GridLayout {
	if e == nil {
		return nil
	}
	return e.GridLayout
...
func (e *EntitySchemaUIConfig) GetWidgetOrder() []string {
	if e == nil {
		return nil
	}
...
func (e *EntitySchema) GetManifest() []string {
	if e == nil {
		return nil
	}
	return e.Manifest
