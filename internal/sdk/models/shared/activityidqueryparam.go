...
type ActivityIDQueryParam struct {
	Str                   *string                `queryParam:"inline,name=ActivityIdQueryParam" union:"member"`
	ActivityIDQueryParam2 *ActivityIDQueryParam2 `queryParam:"inline,name=ActivityIdQueryParam" union:"member"`
