...
type SavedViewPartialCreatedBy struct {
	SavedViewPartial1 *SavedViewPartial1 `queryParam:"inline,name=created_by" union:"member"`
	SavedViewPartial2 *SavedViewPartial2 `queryParam:"inline,name=created_by" union:"member"`
