...
type SavedViewPartialCreatedBy struct {
	SavedViewPartial1 *SavedViewPartial1 `queryParam:"inline"`
	SavedViewPartial2 *SavedViewPartial2 `queryParam:"inline"`
...
func (u *SavedViewPartialCreatedBy) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &savedViewPartial1, "", true, true); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &savedViewPartial2, "", true, true); err == nil {
