...
type EntityOperation struct {
	...
	AutomationChain []string `json:"_automation_chain,omitempty"`
	...
	SourceContext *EntityOperationSourceContext `json:"source_context,omitempty"`
}

func (e *EntityOperation) GetAutomationChain() []string {
	if e == nil {
		return nil
	}
	return e.AutomationChain
}
...
func (e *EntityOperation) GetSourceContext() *EntityOperationSourceContext {
	if e == nil {
		return nil
	}
