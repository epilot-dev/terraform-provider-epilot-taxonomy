...
// InternalUserAttributeDataClassification - Data classification of the attribute, used by anonymized responses (`?anonymize=true` or tokens minted with `anonymize: true`).
//
...
type InternalUserAttributeDataClassification string

const (
	InternalUserAttributeDataClassificationPublic InternalUserAttributeDataClassification = "public"
	InternalUserAttributeDataClassificationPii    InternalUserAttributeDataClassification = "pii"
)

func (e InternalUserAttributeDataClassification) ToPointer() *InternalUserAttributeDataClassification {
	return &e
}
func (e *InternalUserAttributeDataClassification) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "public":
		fallthrough
	case "pii":
		*e = InternalUserAttributeDataClassification(v)
		return nil
	default:
		return fmt.Errorf("invalid value for InternalUserAttributeDataClassification: %v", v)
	}
}
...
type InternalUserAttribute struct {
	...
	// When unset, built-in defaults apply based on the attribute type (email, phone, address, payment) and a curated list of well-known PII fields.
	//
	DataClassification *InternalUserAttributeDataClassification `json:"data_classification,omitempty"`
...
func (i *InternalUserAttribute) GetDataClassification() *InternalUserAttributeDataClassification {
	if i == nil {
		return nil
	}
