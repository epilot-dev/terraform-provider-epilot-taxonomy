...
type SearchFilterValue struct {
	Str     *string  `queryParam:"inline,name=SearchFilterValue" union:"member"`
	Number  *float64 `queryParam:"inline,name=SearchFilterValue" union:"member"`
	Boolean *bool    `queryParam:"inline,name=SearchFilterValue" union:"member"`
