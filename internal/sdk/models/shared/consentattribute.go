...
// ConsentAttributeDataClassification - Data classification of the attribute, used by anonymized responses (`?anonymize=true` or tokens minted with `anonymize: true`).
//
...
type ConsentAttributeDataClassification string

const (
	ConsentAttributeDataClassificationPublic ConsentAttributeDataClassification = "public"
	ConsentAttributeDataClassificationPii    ConsentAttributeDataClassification = "pii"
)

func (e ConsentAttributeDataClassification) ToPointer() *ConsentAttributeDataClassification {
	return &e
}
func (e *ConsentAttributeDataClassification) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "public":
		fallthrough
	case "pii":
		*e = ConsentAttributeDataClassification(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ConsentAttributeDataClassification: %v", v)
	}
}
...
type ConsentAttribute struct {
	...
	// When unset, built-in defaults apply based on the attribute type (email, phone, address, payment) and a curated list of well-known PII fields.
	//
	DataClassification *ConsentAttributeDataClassification `json:"data_classification,omitempty"`
...
func (c *ConsentAttribute) GetDataClassification() *ConsentAttributeDataClassification {
	if c == nil {
		return nil
	}
