...
// ComputedAttributeDataClassification - Data classification of the attribute, used by anonymized responses (`?anonymize=true` or tokens minted with `anonymize: true`).
//
...
type ComputedAttributeDataClassification string

const (
	ComputedAttributeDataClassificationPublic ComputedAttributeDataClassification = "public"
	ComputedAttributeDataClassificationPii    ComputedAttributeDataClassification = "pii"
)

func (e ComputedAttributeDataClassification) ToPointer() *ComputedAttributeDataClassification {
	return &e
}
func (e *ComputedAttributeDataClassification) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "public":
		fallthrough
	case "pii":
		*e = ComputedAttributeDataClassification(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ComputedAttributeDataClassification: %v", v)
	}
}
...
type ComputedAttribute struct {
	...
	// When unset, built-in defaults apply based on the attribute type (email, phone, address, payment) and a curated list of well-known PII fields.
	//
	DataClassification *ComputedAttributeDataClassification `json:"data_classification,omitempty"`
...
func (c *ComputedAttribute) GetDataClassification() *ComputedAttributeDataClassification {
	if c == nil {
		return nil
	}
