...
// TextAttributeDataClassification - Data classification of the attribute, used by anonymized responses (`?anonymize=true` or tokens minted with `anonymize: true`).
//
...
type TextAttributeDataClassification string

const (
	TextAttributeDataClassificationPublic TextAttributeDataClassification = "public"
	TextAttributeDataClassificationPii    TextAttributeDataClassification = "pii"
)

func (e TextAttributeDataClassification) ToPointer() *TextAttributeDataClassification {
	return &e
}
func (e *TextAttributeDataClassification) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "public":
		fallthrough
	case "pii":
		*e = TextAttributeDataClassification(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TextAttributeDataClassification: %v", v)
	}
}
...
type TextAttribute struct {
	...
	// When unset, built-in defaults apply based on the attribute type (email, phone, address, payment) and a curated list of well-known PII fields.
	//
	DataClassification *TextAttributeDataClassification `json:"data_classification,omitempty"`
...
func (t *TextAttribute) GetDataClassification() *TextAttributeDataClassification {
	if t == nil {
		return nil
	}
