...
func newImportExport(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ImportExport {
	return &ImportExport{
		rootSDK:          rootSDK,
...
func (s *ImportExport) AbortEntityImport(ctx context.Context, request operations.AbortEntityImportRequest, opts ...operations.Option) (*operations.AbortEntityImportResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/entity:abortImport")
	if err != nil {
	...
	res := &operations.AbortEntityImportResponse{
	...
	case httpRes.StatusCode == 202:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.AbortEntityImportResponseBody
	...
	case httpRes.StatusCode == 429:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.AbortEntityImportImportExportResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *ImportExport) ExportEntities(ctx context.Context, request operations.ExportEntitiesRequest, opts ...operations.Option) (*operations.ExportEntitiesResponse, error) {
	...
	case httpRes.StatusCode == 429:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ExportEntitiesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *ImportExport) ImportEntities(ctx context.Context, request operations.ImportEntitiesRequest, opts ...operations.Option) (*operations.ImportEntitiesResponse, error) {
	...
	case httpRes.StatusCode == 429:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ImportEntitiesResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
