...
func newInternal(rootSDK *SDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Internal {
	return &Internal{
		rootSDK:          rootSDK,
...
func (s *Internal) GetElasticClusterForOrg(ctx context.Context, request operations.GetElasticClusterForOrgRequest, opts ...operations.Option) (*operations.GetElasticClusterForOrgResponse, error) {
