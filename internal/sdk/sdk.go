...
// Generated from OpenAPI doc version 2.9.0 and generator version 2.918.3
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.12.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.12.0 2.918.3 2.9.0 github.com/epilot-dev/terraform-provider-epilot-taxonomy/internal/sdk",
