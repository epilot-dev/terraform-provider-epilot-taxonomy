...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.623.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.9.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.9.0 2.623.0 1.0.0 github.com/epilot-dev/terraform-provider-epilot-taxonomy/internal/sdk",
