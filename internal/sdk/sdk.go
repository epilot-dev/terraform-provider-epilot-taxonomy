...
// Generated from OpenAPI doc version 2.2.0 and generator version 2.778.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.11.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.11.0 2.778.0 2.2.0 github.com/epilot-dev/terraform-provider-epilot-taxonomy/internal/sdk",
