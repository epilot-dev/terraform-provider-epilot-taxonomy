...
// Generated from OpenAPI doc version 2.0.0 and generator version 2.721.3
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.11.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.11.0 2.721.3 2.0.0 github.com/epilot-dev/terraform-provider-epilot-taxonomy/internal/sdk",
